  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          to: 'https://github.com/react-native-google-signin/google-signin-next/tree/main/example',
          label: 'Example native app',
          position: 'left',
        },
        {
          to: 'https://github.com/react-native-google-signin/google-signin-next/tree/main/web-example',
