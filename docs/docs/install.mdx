...
✅ supports the new One-tap sign-in on Android, through the [Credential Manager](https://developers.google.com/identity/android-credential-manager) and [Web](https://developers.google.com/identity/gsi/web/guides/features), fully compatible (same API) with iOS
...
When you become a sponsor (using one of the monthly tiers that grant access to the private repo), you will [automatically*](#invitation-note) be given access to the private package and invited to the private repo with the latest version of the package.

Thank you for supporting continued maintenance and development of this module! ❤️

Alternatively, you can install from the public registry which will install an older version without the benefits listed above.
