...
✅ Support for the [React Native New Architecture](https://reactnative.dev/docs/new-architecture-intro)

✅ Enhanced API functionalities: synchronous methods and more, plus bugfixes.
...
[Upon sponsoring](https://github.com/sponsors/vonovak) (using one of the monthly tiers that grant access to the private repo), you will get [immediate access *](#invitation-note) to the private package and to the private repo with the latest version of the package.
