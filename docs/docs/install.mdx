...
✅ supports the new One Tap sign-in on Android and Web, fully compatible (same API) with iOS
...
When you become a sponsor using one of the marked tiers, you will automatically be invited to a private repo with the latest version of the package.
