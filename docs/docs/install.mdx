...
When you become a sponsor (using one of the tiers that grant access to the private repo), you will [automatically*](#invitation-note) be given access to the private package and invited to the private repo with the latest version of the package.
